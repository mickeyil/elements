...
Devices ACK after SET_PROFILE and LOAD. Other commands are fire-and-forget (TCP guarantees delivery).
...
status, rescan_programs, publish_program, add_device, edit_device,
remove_device, reboot_device, shutdown
```
